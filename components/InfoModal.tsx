...
const InfoModal: React.FC<InfoModalProps> = ({ visible, onClose }) => {
    ...
    return (
        <div className="z-50 transition duration-200 bg-black bg-opacity-80 flex justify-center items-center overflow-x-hidden overflow-y-auto fixed inset-0">
            <div className="relative w-auto mx-auto max-3-3xl rounded-md overflow-hidden">
